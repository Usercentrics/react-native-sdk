...
if (!fs.existsSync(packageJsonPath)) {
  printError(
    "package.json not found. Make sure you're running this script from the SDK root directory.",
  )
  process.exit(1)
}
...
try {
  ...
  printWarning(
    "Don't forget to test thoroughly before publishing to npm registry.",
  )
} catch (error) {
